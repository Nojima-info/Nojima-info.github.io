...
const events = [
  ...
  prices: ["SS席・15000円(税込)", "S席・13000円(税込)", "A席・11000円(税込)", "注釈付きSS席・15000円(税込)", "注釈付きA席・11000円(税込)", "見切れ席・9000円(税込)", "配信・3800円(税込)"],
  links: [
  ...
  prices: ["現地・6000円(税込、全席指定)", "配信・3500円(税込)"],
  links: [
